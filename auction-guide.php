...
<!-- Mirrored from demo.egenslab.com/html/probid/preview/antiques-auction/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Aug 2024 14:20:52 GMT -->
<head>
...
<title>Probid- Multi Vendor Auction and Bidding HTML Template.</title>
<link rel="icon" href="https://demo.egenslab.com/html/probid/preview/assets/img/fav-icon.svg" type="image/gif" sizes="20x20">
</head>
<body id="body" class="eg-antique-home">
...
<div class="topbar-area style-3">
<div class="container">
<div class="topbar-wrap">
<div class="topbar-left">
<ul class="contact-area">
<li>
<a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#1f767179705f7a677e726f737a317c7072">
...
<span class="__cf_email__" data-cfemail="c7aea9a1a887a2bfa6aab7aba2e9a4a8aa">[email&#160;protected]</span>
</a>
</li>
<li>
<a href="#">
...
<div class="home5-about-section pt-110 mb-110">
<div class="container">
...
<p>We register all buyers and sellers with a permanent client number that can be used to buy or sell at our sales.</p>

<p>We require proof of identity and address such as a photographic driver’s licence and a recent utility bill.
</p>
<p>In completing the online bidder registration you:</p>

<ul style="list-style: disc;">
    <li>1. Agree to abide by the auctioneer’s conditions of sale and terms and conditions,</li>
   <li>2. Agree to make payment by the methods and timescales stated above.</li> 
    <li>3. Understand that failure to make payment or to collect your purchases will lead to your accounts with CLS being suspended/removed. May incurr storage & removal fee if not collected </li>
    <li>4. Buyers Premium is 20% of hammer price, some lots carry VAT in addion to the final hammer price. This is made clear on the stock listing, where price is mentioned.</li>
...
<div class="section-title pt-5">
    <h3>Auction Registration Form</h3>
<p>Register for your Online Auction account here at Container Liquidation Services Ltd<br>
Our Online Auction Account Registration Form<br>
...
<section class="h-100">
    <div class="container py-5 h-100">
            ...
            <div class="row g-0">
              ...
              <div class="col-xl-6">
                <div class="card-body p-md-5 text-black">
                  ...
                  <h3 class=" text-uppercase">Stock request form</h3>
                  <p class="py-2">Please fill in the form below and tell us what stock or item you are looking for</p>
     ...
     <div class="section-title">
        ...
        <p>All auction lot payments must be made securely ONLINE by card or bank transfer.</p>

        <p>Due to COVID-19 we are not accepting cash payment.</p>
        
         <p>All required payments will be settled in full and before removal of the Lot is permitted and will be in GBP (Sterling), Bank Draft/transfer, Debit Cards,</p>
    ...
    <div class="section-title">
        ...
        <p>Some lots in this sale will attract VAT on the hammer price. Please read carefully on the lot description</p>
    ...
    <div class="section-title">
        <h2> <span>ADDITIONAL CHARGES</span></h2>
        <p>All bids placed are subject to the addition of both Buyers Premium @20% and addition of  VAT  @20%  incurred on all lots/invoice totals unless otherwise stated.</p>

        <p>Contact us for more information 07902 895 721 or email: info@containerliquidationservices.co.uk </p>
       
    </div>

    
    <div class="section-title">
        <h2> <span>DO YOU DELIVER GOODS?</span></h2>
       
       <p>Delivery is extra as we don’t allow collections without prior approval & arrangement.</p> 

<p>We offer delivery on all stocks but we are also flexible to accept those who want to set you their courier and delivery service.</p>

<p>Some of the lots is DELIVERY only and that is sorted by CLS and delivery cost will be included in the invoice.</p>

<p>Contact us to sort the delivery: 07902 895 721 or email: info@containerliquidationservices.co.uk </p>

<p>Buyers can use their own couriers but they must give the auctioneers at least 24 hours’ notice prior to the collection.
</p>
<p>There is no standard delivery cost as the costs differs depending on the type of lot, pallets or container  and delivery address.</p>
...
<!-- Mirrored from demo.egenslab.com/html/probid/preview/antiques-auction/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Aug 2024 14:20:53 GMT -->
</html>